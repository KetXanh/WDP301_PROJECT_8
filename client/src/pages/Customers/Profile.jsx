...
import { ArrowLeft, User, Mail, Phone, MapPin, Calendar, Edit3 } from 'lucide-react';
...
const Profile = () => {
    ...
    const handleInputChange = (e) => {
        ...
        if (["fullName", "phone", "street", "ward", "district", "province"].includes(name)) {
            setFormData(prev => ({
                ...prev,
                address: [
                    {
                    ...
                    <CardHeader className="text-center pb-2">
                        <div className="relative">
                            <Avatar className="w-24 h-24 mx-auto mb-4">
                                <AvatarImage src={formData.avatar?.url} alt={getDisplayName()} />
                        ...
                        <CardDescription className="text-gray-600">
                            {isEditing ? 'Chỉnh sửa thông tin của bạn' : 'Xem và quản lý thông tin cá nhân'}
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-900">{formData.username || "Hãy Cập Nhật Thông Tin Cá Nhân"}</p>
                                    )}
                                </div>
                                <div className="flex-1">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-900">{formData?.address[0]?.fullName || "Hãy Cập Nhật Thông Tin Cá Nhân"}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-900">{formData.email || "Hãy Cập Nhật Thông Tin Cá Nhân"}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-900">{formData.address.length === 0 ? "Hãy Cập Nhật Thông Tin Cá Nhân" : `${formData.address[0].street} ${formData.address[0].ward} ${formData.address[0].district} ${formData.address[0].province}`}</p>
                                    )}
                                </div>
                            </div>
                        </div>
